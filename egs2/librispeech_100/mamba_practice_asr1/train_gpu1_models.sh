#!/usr/bin/env bash
# Train all 71 models from gpu_id_1_config.txt sequentially
# Each model will be trained with its specific module_config and num_blocks
# GPU 1 is used for all training
...
# Input file
INPUT_FILE="${SCRIPT_DIR}/gpu_id_1_config.txt"
...
echo "=================================================================================="
echo "Training All Models from gpu_id_1_config.txt Sequentially"
echo "Using GPU 1"
echo "=================================================================================="
echo ""
...
while IFS=$'\t' read -r module_config block_params num_blocks total_params <&3; do
    ...
    echo "=================================================================================="
    echo "Model ${model_idx}/141: Training"
    echo "=================================================================================="
    ...
    EXP_DIR="${SCRIPT_DIR}/exp/gpu1_${SAFE_CONFIG}_asr_train_asr_raw_en_bpe1000_sp"
